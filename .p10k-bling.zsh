# Generated by Powerlevel10k configuration wizard on 2022-01-21 at 23:30 -03.
...
# right frame, lightest-ornaments, sparse, many icons, fluent, instant_prompt=verbose.
...
() {
  ...
  typeset -g POWERLEVEL9K_OS_ICON_BACKGROUND=40
  # Custom icon.
